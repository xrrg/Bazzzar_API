...
class ExtraFieldDescription(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'Описания дополнительных полей'
...
class Advertisement(models.Model):
    ...
    condition = models.BooleanField(help_text='Не Б/У')  # New - True, if used one - False
...
class Commercial(models.Model):  # Create by administration
    ...
    position = models.SmallIntegerField(default=0, help_text='0 - верхний левый блок, 1 - верхний правый блок,'
                                                             ' 2 - 1-й средний блок, 3 - 2-й средний блок'
                                                             ' , 4 - нижний блок' )
...
class DatatimeTable(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'Даты объявления'
